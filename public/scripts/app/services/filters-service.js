...
module.exports = /*@ngInject*/ function() {
    ...
    function DisplacementMap(source, map, target, point, scaleX, scaleY, channelX, channelY) {
        this.source = source;
        this.map = map;
        this.target = target;
        ...
        this.channelX = channelX || ColorChannel.RED;
        this.channelY = channelY || ColorChannel.RED;
        if (this.channelX != 0 && this.channelX != 1 && this.channelX != 2 && this.channelX != 3) this.channelX = ColorChannel.RED;
        if (this.channelY != 0 && this.channelY != 1 && this.channelY != 2 && this.channelY != 3) this.channelY = ColorChannel.RED;
    };

    var p = DisplacementMap.prototype;
    ...
    p.draw = function() {
        ...
        while(i < pixelsLength) {
            ...
            alphaValue = mapData.data[i*4+ColorChannel.ALPHA];
